...
function 0x1631(uint256 varg0) private {
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0xa3d(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0xaed6f78e() public payable {
    ...
    require(v2 == bool(v2));
    require(v2, Error(0x4e65656420417070726f766564203120e7b1af));
    require(msg.sender - address(0x0), Error('ERC20: mint to the zero address'));
    v3 = _SafeAdd(_totalSupply, 666);
    _totalSupply = v3;
    v4 = _SafeAdd(_balanceOf[msg.sender], 666);
    _balanceOf[msg.sender] = v4;
    emit Transfer(address(0x0), msg.sender, 666);
}
...
function 0x35b() private {
    v0 = 0x1631(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1631(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function 0x619() private {
    v0 = 0x1631(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1631(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
...
function 0xc00(uint256 varg0, uint256 varg1, uint256 varg2) private {
    ...
    if (v0 != uint256.max) {
        ...
        0xa3d(v0 - varg0, varg1, varg2);
    }
    return ;
}

function 0xc8b(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function 0xf00(uint256 varg0, uint256 varg1) private {
...
function __function_selector__(bytes4 function_selector) public payable {
    ...
    } else if (0xaed6f78e == function_selector >> 224) {
        0xaed6f78e();
