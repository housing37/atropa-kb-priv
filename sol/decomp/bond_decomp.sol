...
function 0x105b(uint256 varg0, address varg1, address varg2) private {
...
function 0x121e(uint256 varg0, uint256 varg1, uint256 varg2) private {
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 != uint256.max) {
        require(v0 >= varg0, Error('ERC20: insufficient allowance'));
        0x105b(v0 - varg0, varg1, varg2);
    }
    return ;
}

function 0x12a9(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function approve(address varg0, uint256 varg1) public payable {
    ...
    require(varg0 == varg0);
    require(varg1 == varg1);
    0x105b(varg1, varg0, msg.sender);
    return bool(1);
}

function 0x151e(uint256 varg0, uint256 varg1) private {
...
function transferFrom(address varg0, address varg1, uint256 varg2) public payable {
    ...
    require(varg1 == varg1);
    require(varg2 == varg2);
    0x121e(varg2, msg.sender, varg0);
    0x12a9(varg2, varg1, varg0);
    return bool(1);
}
...
function 0x1c4f(uint256 varg0) private {
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function 0x1e0e(uint256 varg0, uint8 varg1) private {
...
function 0x467c4e68() public payable {
    ...
    require(v3 == bool(v3));
    require(v3, Error('Need Approved 1 LEGAL'));
    v4 = 0x1e0e(10, 18);
    v5 = _SafeMul(500, v4);
    v6, /* bool */ v7 = stor_b_0_19.transferFrom(msg.sender, address(this), v5).gas(msg.gas);
    require(bool(v6), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v7 == bool(v7));
    require(v7, Error(0x4e65656420417070726f7665642035303020e3889d));
    v8 = 0x1e0e(10, 18);
    v9 = _SafeMul(900, v8);
    v10, /* bool */ v11 = stor_c_0_19.transferFrom(msg.sender, address(this), v9).gas(msg.gas);
    require(bool(v10), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v11 == bool(v11));
    require(v11, Error(0x4e65656420417070726f7665642039303020e7b1af));
    v12 = 0x1e0e(10, 18);
    v13 = _SafeMul(999, v12);
    v14, /* bool */ v15 = stor_8_0_19.transferFrom(msg.sender, address(this), v13).gas(msg.gas);
    require(bool(v14), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v15 == bool(v15));
    require(v15, Error(0x4e65656420417070726f7665642039393920de8d));
    v16 = 0x1e0e(10, 18);
    v17 = _SafeMul(313, v16);
    v18, /* bool */ v19 = stor_6_0_19.transferFrom(msg.sender, address(this), v17).gas(msg.gas);
    require(bool(v18), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v19 == bool(v19));
    require(v19, Error('Need Approved 313 ATROPA'));
    v20 = 0x1e0e(10, 18);
    v21 = _SafeMul(0x186a0, v20);
    v22, /* bool */ v23 = stor_a_0_19.transferFrom(msg.sender, address(this), v21).gas(msg.gas);
    require(bool(v22), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v23 == bool(v23));
    require(v23, Error('Need Approved 100,000 TREASURY BILL'));
    v24 = 0x1e0e(9, 18);
    v25 = _SafeMul(1311, v24);
    v26, /* bool */ v27 = stor_9_0_19.transferFrom(msg.sender, address(this), v25).gas(msg.gas);
    require(bool(v26), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v27 == bool(v27));
    require(v27, Error(0x4e65656420417070726f766564203133312e3120e291a7));
    v28 = 0x1e0e(10, 18);
    require(msg.sender - address(0x0), Error('ERC20: mint to the zero address'));
    v29 = _SafeAdd(_totalSupply, v28);
    _totalSupply = v29;
    v30 = _SafeAdd(_balanceOf[msg.sender], v28);
    _balanceOf[msg.sender] = v30;
    emit Transfer(address(0x0), msg.sender, v28);
}
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0x105b(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0x35b() private {
    v0 = 0x1c4f(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1c4f(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function 0xd46() private {
    v0 = 0x1c4f(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1c4f(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
