...
function transferFrom(address varg0, address varg1, uint256 varg2) public payable {
    ...
    require(varg1 == varg1);
    require(varg2 == varg2);
    0xc01(varg2, msg.sender, varg0);
    0xc8c(varg2, varg1, varg0);
    return bool(1);
}
...
function 0x4a50bbf3(uint256 varg0) public payable {
    ...
    require(v1 == bool(v1));
    require(v1, Error(20079));
    require(msg.sender - address(0x0), Error('ERC20: mint to the zero address'));
    v2 = _SafeAdd(_totalSupply, varg0);
    _totalSupply = v2;
    v3 = _SafeAdd(_balanceOf[msg.sender], varg0);
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0xa3e(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0x36d() private {
    v0 = 0x1632(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1632(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function 0x729() private {
    v0 = 0x1632(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1632(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
...
function 0xa3e(uint256 varg0, address varg1, address varg2) private {
...
function 0xc01(uint256 varg0, uint256 varg1, uint256 varg2) private {
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 != uint256.max) {
        require(v0 >= varg0, Error('ERC20: insufficient allowance'));
        0xa3e(v0 - varg0, varg1, varg2);
    }
    return ;
}

function 0xc8c(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function 0xf01(uint256 varg0, uint256 varg1) private {
...
function __function_selector__(bytes4 function_selector) public payable {
    ...
    if (msg.data.length < 4) {
        ...
        if (0x313ce567 > function_selector >> 224) {
            ...
            require(0x4a50bbf3 == function_selector >> 224);
            0x4a50bbf3();
        }
