...
function 0x1751(uint256 varg0) private {
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function transferFrom(address varg0, address varg1, uint256 varg2) public payable {
    ...
    require(varg1 == varg1);
    require(varg2 == varg2);
    0xd20(varg2, msg.sender, varg0);
    0xdab(varg2, varg1, varg0);
    return bool(1);
}
...
function 0x1978(uint256 varg0, uint8 varg1) private {
...
function 0x76fade90() public payable {
    ...
    v4 = 0x1978(10, 18);
    v5 = _SafeMul(1, v4);
    v6, /* bool */ v7 = stor_6_0_19.transferFrom(msg.sender, address(this), v5).gas(msg.gas);
    require(bool(v6), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v7 == bool(v7));
    require(v7, Error(0x4e65656420417070726f766564203120e7acace4bd9c));
    v8 = 0x1978(10, 18);
    v9 = _SafeMul(1, v8);
    require(msg.sender - address(0x0), Error('ERC20: mint to the zero address'));
    v10 = _SafeAdd(_totalSupply, v9);
    _totalSupply = v10;
    v11 = _SafeAdd(_balanceOf[msg.sender], v9);
    _balanceOf[msg.sender] = v11;
    emit Transfer(address(0x0), msg.sender, v9);
}
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0xb5d(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0x35b() private {
    v0 = 0x1751(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1751(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function 0x848() private {
    v0 = 0x1751(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x1751(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
...
function 0xb5d(uint256 varg0, address varg1, address varg2) private {
...
function 0xd20(uint256 varg0, uint256 varg1, uint256 varg2) private {
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 != uint256.max) {
        require(v0 >= varg0, Error('ERC20: insufficient allowance'));
        0xb5d(v0 - varg0, varg1, varg2);
    }
    return ;
}

function 0xdab(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function __function_selector__(bytes4 function_selector) public payable {
    ...
    if (msg.data.length < 4) {
        ...
        if (0x715018a6 == function_selector >> 224) {
            renounceOwnership();
        } else if (0x76fade90 == function_selector >> 224) {
            0x76fade90();
