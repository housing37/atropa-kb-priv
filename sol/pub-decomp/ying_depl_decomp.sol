...
function approve(address varg0, uint256 varg1) public payable {
    ...
    require(varg0 == varg0);
    require(varg1 == varg1);
    0x93d(varg1, varg0, msg.sender);
    return bool(1);
}

function 0x141f(uint256 varg0) private {
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function transferFrom(address varg0, address varg1, uint256 varg2) public payable {
    ...
    require(varg1 == varg1);
    require(varg2 == varg2);
    0xb06(varg2, msg.sender, varg0);
    0xb92(varg2, varg1, varg0);
    return bool(1);
}
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0x93d(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0x349() private {
    v0 = 0x141f(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x141f(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function 0x618() private {
    v0 = 0x141f(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x141f(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
...
function 0x93d(uint256 varg0, address varg1, address varg2) private {
...
function 0xb06(uint256 varg0, uint256 varg1, uint256 varg2) private {
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 != uint256.max) {
        require(v0 >= varg0, Error('ERC20: insufficient allowance'));
        0x93d(v0 - varg0, varg1, varg2);
    }
    return ;
}

function 0xb92(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function 0xe11(uint256 varg0, uint256 varg1) private {
