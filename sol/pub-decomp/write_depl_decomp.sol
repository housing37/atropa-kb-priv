...
function 0x1254() private {
    v0 = 0x215d(array_4.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x215d(array_4.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_4.data;
...
function approve(address varg0, uint256 varg1) public payable {
    ...
    require(varg0 == varg0);
    require(varg1 == varg1);
    0x1569(varg1, varg0, msg.sender);
    return bool(1);
}

function 0x1569(uint256 varg0, address varg1, address varg2) private {
...
function 0x172c(uint256 varg0, uint256 varg1, uint256 varg2) private {
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 != uint256.max) {
        require(v0 >= varg0, Error('ERC20: insufficient allowance'));
        0x1569(v0 - varg0, varg1, varg2);
    }
    return ;
}
...
function transferFrom(address varg0, address varg1, uint256 varg2) public payable {
    ...
    require(varg1 == varg1);
    require(varg2 == varg2);
    0x172c(varg2, msg.sender, varg0);
    0x17b7(varg2, varg1, varg0);
    return bool(1);
}

function 0x17b7(uint256 varg0, uint256 varg1, uint256 varg2) private {
...
function 0x1a2c(uint256 varg0, uint256 varg1) private {
...
function burn(uint256 varg0) public payable {
    ...
    require(varg0 == varg0);
    0x1a2c(varg0, msg.sender);
}

function 0x467c4e68() public payable {
    v0 = 0x231c(10, 18);
    v1 = _SafeMul(7, v0);
    ...
    require(v3 == bool(v3));
    require(v3, Error(0x4e65656420417070726f766564203720ca81));
    v4 = 0x231c(10, 18);
    v5 = _SafeMul(3135, v4);
    ...
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v7 == bool(v7));
    require(v7, Error('Need Approved 3135 LEGAL'));
    v8 = 0x231c(10, 18);
    v9 = _SafeMul(3135, v8);
    ...
    require(v11, Error('Need Approved 3135 scissors'));
    v12 = 0x231c(10, 18);
    v13 = _SafeMul(0x30d40, v12);
    ...
    require(v15, Error(0x4e65656420417070726f766564203230302c30303020e0a6aae0a681e0a6a6e0a6bee0a787e0a6bce0a6a8e0a781e0a6bfe0a682));
    v16 = 0x231c(10, 18);
    v17 = _SafeMul(1, v16);
    ...
    require(v19, Error(0x4e65656420417070726f766564203120e7acace4bd9c));
    v20 = 0x231c(10, 18);
    v21 = _SafeMul(0xb71b00, v20);
    v22, /* bool */ v23 = stor_b_0_19.transferFrom(msg.sender, address(this), v21).gas(msg.gas);
    require(bool(v22), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v23 == bool(v23));
    require(v23, Error('Need Approved 12,000,000 dOWN'));
    v24 = 0x231c(10, 18);
    v25 = _SafeMul(0x2dc6c0, v24);
    v26, /* bool */ v27 = stor_c_0_19.transferFrom(msg.sender, address(this), v25).gas(msg.gas);
    require(bool(v26), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v27 == bool(v27));
    require(v27, Error(0x4e65656420417070726f76656420332c3030302c30303020de8d));
    v28 = 0x231c(10, 18);
    v29 = _SafeMul(2600, v28);
    v30, /* bool */ v31 = stor_d_0_19.transferFrom(msg.sender, address(this), v29).gas(msg.gas);
    require(bool(v30), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v31 == bool(v31));
    require(v31, Error(0x4e65656420417070726f766564203236303020e291a7));
    v32 = 0x231c(10, 18);
    v33 = _SafeMul(0x186a0, v32);
    v34, /* bool */ v35 = stor_e_0_19.transferFrom(msg.sender, address(this), v33).gas(msg.gas);
    require(bool(v34), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v35 == bool(v35));
    require(v35, Error(0x4e65656420417070726f766564203130302c30303020ec9ca0));
    v36 = 0x231c(10, 18);
    v37 = _SafeMul(0x2687614, v36);
    v38, /* bool */ v39 = stor_f_0_19.transferFrom(msg.sender, address(this), v37).gas(msg.gas);
    require(bool(v38), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v39 == bool(v39));
    require(v39, Error(0x4e65656420417070726f7665642034302c3430302c34303420e0b984e0b8a1e0b8b4e0b895e0b8b4e0b88be0b8aae0b98c));
    v40 = 0x231c(10, 18);
    v41 = _SafeMul(0x1e8480, v40);
    v42, /* bool */ v43 = stor_10_0_19.transferFrom(msg.sender, address(this), v41).gas(msg.gas);
    require(bool(v42), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v43 == bool(v43));
    require(v43, Error(0x4e65656420417070726f76656420322c3030302c30303020e389a3));
    v44 = 0x231c(10, 18);
    v45 = _SafeMul(1, v44);
    v46, /* bool */ v47 = stor_11_0_19.transferFrom(msg.sender, address(this), v45).gas(msg.gas);
    require(bool(v46), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    MEM[64] = MEM[64] + (RETURNDATASIZE() + 31 & ~0x1f);
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v47 == bool(v47));
    require(v47, Error('Need Approved 1 First Pulse Mutual Bond'));
    v48 = 0x231c(10, 18);
    require(msg.sender - address(0x0), Error('ERC20: mint to the zero address'));
    v49 = _SafeAdd(_totalSupply, v48);
    _totalSupply = v49;
    v50 = _SafeAdd(_balanceOf[msg.sender], v48);
    _balanceOf[msg.sender] = v50;
    emit Transfer(address(0x0), msg.sender, v48);
}

function 0x215d(uint256 varg0) private {
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function 0x231c(uint256 varg0, uint8 varg1) private {
...
function decreaseAllowance(address varg0, uint256 varg1) public payable {
    ...
    0x1569(_allowance[msg.sender][varg0] - varg1, varg0, msg.sender);
    return bool(1);
}
...
function 0x35b() private {
    v0 = 0x215d(array_3.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x215d(array_3.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
        v5 = v6 = array_3.data;
...
function __function_selector__(bytes4 function_selector) public payable {
    ...
    if (msg.data.length < 4) {
        ...
        if (0x313ce567 > function_selector >> 224) {
            ...
            require(0x467c4e68 == function_selector >> 224);
            0x467c4e68();
        }
