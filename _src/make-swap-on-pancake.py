...
'''
house_101523:
    :- added web3-ethereum-defi test integration (could not get working)
        - added make-swap-on-pancake.py
            modified in attempts to swap token for token on pulschain
            - could not get working
            - wound up working with native web3 library solution
                swap_exact_tokens_for_tokens, etc.
'''
# requirements: (python3.10)
#   1) ref: https://github.com/tradingstrategy-ai/web3-ethereum-defi
#       $ python3.10 -m pip install web3-ethereum-defi
#   2) ref: https://github.com/tradingstrategy-ai/web3-ethereum-defi/tree/master/eth_defi
#       copy folder to this directory: ./eth_defi/

# OG: make-swap-on-pancake.py
...
QUOTE_TOKEN_ADDRESS = "0xA1077a294dDE1B09bB078844df40758a5D0f9a27"  # WPLS # house
...
BASE_TOKEN_ADDRESS = "0x6B175474E89094C44Da98b954EedeAC495271d0F"  # pDAI # house
...
json_rpc_url = 'https://rpc.pulsechain.com' # house
assert json_rpc_url, "You need to give pulsechain rpc node URL... 'https://rpc.pulsechain.com'"
...
dex = fetch_deployment(
    ...
    # PLP v1 pDAI:WPLS (0x947b4633e32E0c7f2c76753B43F008480715416D)
    factory_address='0x1715a3e4a142d8b698131108995174f37aeba10d', # PLP's factory
    init_code_hash='0x307835396666666666646464373536636261393039353132386535336633323931613662613338623231653364663734343933366537323839333236353535643632', # factory's init code hash
    router_address='0x98bf93ebf5c380C0e6Ae8e192A7e2AE08edAcc02', # PulseXRouter02 _ v1

    # PLP v2 pDAI:WPLS (0xaE8429918FdBF9a5867e3243697637Dc56aa76A1)
    #factory_address='0x29eA7545DEf87022BAdc76323F373EA1e707C523', # PLP's factory
    #init_code_hash='0x307835646666316163326431333266356163323834313239346336653966633065626166616538643434376661633739393665663231633231313132663431316631', # factory's init code hash
    #router_address='0x165C3410fC91EF562C50559f7d2289fEbed552d9', # PulseXRouter02 _ v2
    
    # PulseXRouter02 (0x98bf93ebf5c380C0e6Ae8e192A7e2AE08edAcc02) v2 router
#    factory_address='0x1715a3E4A142d8b698131108995174F37aEBA10D', # v2 router's factory
#    init_code_hash='0x307835396666666666646464373536636261393039353132386535336633323931613662613338623231653364663734343933366537323839333236353535643632', # factory's init code hash
#    router_address='0x98bf93ebf5c380C0e6Ae8e192A7e2AE08edAcc02', # v2 router
)

# LP pDAI:WPLS -> 0xaE8429918FdBF9a5867e3243697637Dc56aa76A1
...
private_key = '0x'+os.environ['PRIVATE_KEY_4'] # house: 0x75621f628DF0748Ae8475FcD44ed394feB9819BD
