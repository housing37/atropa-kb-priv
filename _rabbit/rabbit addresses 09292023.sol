...
address constant TSFiContract = address(0x4243568Fa2bbad327ee36e06c16824cAd8B37819);     //corrected
...
///////////////////////////////////
address constant KnightsOfMaltaContract = address(0xee62EE9A354E55dF7C39209B4304161369333fF7);  //✠
address constant ӨContract = address(0xCd19062a6d3019b02A676D72e51D8de7A398dE25); //Ө
address constant MonatMoneyContract = address(0xf8AB3393b1f5CD6184Fb6800A1fC802043C4063e);
address constant CrowsContract = address(0x203e366A1821570b2f84Ff5ae8B3BdeB48Dc4fa1);
address constant HungLaoContract = address(0xd6077A029Fb5BEF33b02391D7f0349c345F6DDb1); //ຮູງ໊
address constant 2ccContract = address(0x6293373BF0DAE2050641973D49b7b2f71adC91a1);
address constant GothicRethinaContract = address(0xe5d3A6e88590fc2A8037D9CCbd816C05B1ff5f11);
address constant GasiyutaContract = address(0xb9A44De20f26a027e467CB6c2F98766F01904189); //ᎦᏆᏙᏗ
address constant GanuhulasgiContract = address(0x83a918056aB9316837Dc48a216119D679D561d91);//ᎧᏃ
address constant KpaContract = address(0x7FB09EE1a2c0E8b6D1c4E19C0248B3CbC0113af6); //ߝߐߔߎߌߖߦ
address constant GoodMorningContract = address(0xb4C1248812dAbF72cb2e82175b4c0aCffE4D2b10);  //ᜮᜳᜪᜯᜳᜰᜲ᜶ᜤ᜴
address constant SANDContract = address(0x22811d185d2996841E79F2668Af87e574890aeF8);
address constant skāūṁkṣaḻuContract = address(0x60Df6bB066a0C643789559a7DE0F8997FAb89f33); //സ്കാൂം
address constant ZürichContract = address(0x583d1C1427308f7f96BFd3E0d7A3F9674D8BF8ec); //Zů
address constant FROCKContract = address(0x8B8b26bB6C5fD4867339ab2f0acf3aE5129BD2F0); //VaticanCity
address constant PhDContract = address(0x6236073377AC7e0aB694957dA5d7d4241e72EBc6);//꤅ꤪꤐꤧꤗ꤬
address constant MorphContract = address(0xF9bC351eef0F1242953Dde097C9e6e57B8FF3A42);  //රුධිර
address constant MonofizitizmContract = address(0xBb341FD5C855c206f5538cc649f90d84Df19b65a); //מונופיזיטיזם
address constant PUNKContract = address(0x7614Fabf7e0b0dfCC0e02A14E720677148c5141d);
address constant FoJinContract = address(0x840CBD20A70774BECAc4e932Fff6fb1f5417997F); //ᥴᥧᥝᥕ
address constant HOESContract = address(0x3f92D9eE64a3E1405302e68EE0fDE9e085f8CE4B);  //Ⴥჸ 
address constant ䷽䷸Contract = address(0x0D4b0C8c4C32dEf9C742014fF17BB21b30B3A762);
address constant GreenlandContract = address(0xdE4Ef7Ea464c7771803b9838AeA07cE41089b054); //ՔՈՏ
address constant ThaiTamContract = address(0x0C662a3Df5d6FbF1902ab5fa2Fe40A0ce377620f);
address constant CanastaContract = address(0x8f326f4530D02c6C5BBF8Acd46DDBB0391871e85);
address constant HiContract = address(0xd18a27A8Df4df35DF570743AA47b08cCF8Ab256B); //⠛⡑
address constant GODContract = address(0xF77c946C18A77B5DdA5e839dA9818C4D1f087393);
address constant HelloContract = address(0x08Fe5c72173044314A74705089d014a4416Ed71D); //⠙⠜⠍⠏⠖
address constant DreidelContract = address(0x8A03b032c5494219B212e5a74A49e2aa7F9d206F); //דרײדל
address constant YTContract = address(0x296E797F481C15d6FE138ceA09Bda3A1c2869216); //Youtube
address constant yjOz1IqBkQkContract = address(0x7c4A08584ca8d889e87fc93331224BCb7947fE0c);  //yjOz1IqBkQk
address constant TimestampContract = address(0xCD775778F15FFf2fb43C0d8149cb888c099f0Ac1); //Timestamp: 17:50
address constant 99W690JMUoContract = address(0xF3352be5de1e6232755C7dbd15a84FC3614a419c);  //99-W690JMUo
address constant WTkfg3LiJZAContract = address(0xd2d26E25Ab8753fF60fA430CF7B7D685752879be);  //WTkfg3LiJZA
address constant Contract = address(0x748F3deDf7A31Ded9Cf6421f44f967e3ed85e83a); //ᚘꠇᝣꤲᚘ
address constant LOANContract = address(0xeE67825eF27588FAeE39cfefb465eB0A242A740c); //瀈
address constant MassacreFreebiesContract = address(0x48F628c079353ECC4DB75F0d05de9299e083f3C2);
address constant NovartisContract = address(0x242E264680054232661Af225467ec286E3F95652);
address constant BurrContract = address(0xF7ebb9bc80fb6395373c6BbDF690fcFfb217a691); BillBurr
address constant Contract = address(0x38D739B86233F7BC9CF82b231AEC4ffa749c2Efb);  //ܐܡܝܕ ܥܢܝ̈ܢܐ ܏ܩܕܡ
