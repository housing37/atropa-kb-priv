...
contract_address = '0x4C1518286E1b8D5669Fe965EF174B8B4Ae2f017B'
contract_symbol = 'Annabelle: The Profit ㉶ _ (BEL ㉶)'
...
#    d_mint = get_usd_val_for_tok_cnt(contract_address, 666 / 1000000000000000000)
    mint_cnt = 666 / (10**18)
